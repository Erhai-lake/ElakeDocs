...
declare const __VLS_component: import("vue").DefineComponent<{
    ...
    readonly collapsible: import("element-plus/es/utils").EpPropFinalized<BooleanConstructor, unknown, unknown, false, boolean>;
    ...
    readonly collapsible: import("element-plus/es/utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
}>;
