...
* 写入变量: [`setVar`](./var/function#写入变量)
* 批量写入变量: [`setVars`](./var/function#批量写入变量)
* 读取变量: [`getVar`](./var/function#读取变量)
* 读取所有变量: [`getVars`](./var/function#读取所有变量)
* 清空变量: [`clearVars`](./var/function#清空变量)
...
* 递归解析对象或数组中的所有模板: [`objectResolve`](template/object_resolve.md)
