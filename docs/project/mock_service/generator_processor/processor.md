...
const UUID = mock.generateData("string", "uuid")
console.log(mock.applyGlobalProcessor("sha", UUID, "SHA512"))
...
const UUID = mock.generateData("string", "uuid")
console.log(mock.applyGlobalProcessor("string", "substr", UUID, {start: 3}))
// 410f8-6cd6
```
:::
...
const UUID = mock.generateData("string", "uuid")
console.log(mock.applyProcessor("string", "uuid", "sha", UUID, "SHA512"))
...
const UUID = mock.generateData("string", "uuid")
console.log(mock.applyProcessor("string", "uuid", "substr", UUID, {start: 3}))
// e1688-e09c
```
:::
